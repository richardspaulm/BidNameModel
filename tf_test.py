...
import format_for_training as fft
scaler = MinMaxScaler()
...
data1 = pd.read_csv("./additional_formatted.csv",  index_col=0)
data1.Labels = data1.Labels.astype(int)
dataset = data1
dataset.Labels = dataset.Labels.astype(int)

dataset = fft.format_df(dataset)
print(dataset.head())
...
print(dataset.head())
# training_targets = preprocess_targets(dataset.head(120000)) 

# validation_examples = preprocess_features(dataset.tail(200))
validation_targets = preprocess_targets(dataset.tail(30000))


print("Normalizing Data")
training_examples = normalize_linear_scale(preprocess_features(dataset.head(120000)))
validation_examples = normalize_linear_scale(preprocess_features(dataset.tail(30000)))
dataset = None
